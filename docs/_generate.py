...
MODULES = [
    ...
    ("M06", "Skills + Slash Commands", "foundation", "M06-skills-slash-commands.md", '<polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/>'),
    ("M07", "Chief of Staff Brief", "personalize", "M07-chief-of-staff-claudemd.md", '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>'),
