...
Filenames are: `M01-welcome-foundations.md`, `M02-prompt-engineering.md`, `M03-cowork-ui-settings.md`, `M04-artifacts.md`, `M05-browser-chrome.md`, `M06-skills-slash-commands.md`, `M07-chief-of-staff-claudemd.md`, `M08-obsidian.md`, `M09-projects-folders-claudemd.md`, `M10-connectors.md`, `M11-office-add-ins.md`, `M12-scheduled-tasks-routines.md`, `M13-gtd-in-your-vault.md`, `M14-daily-command-center.md`, `M15-meeting-notes.md`, `M16-collaboration.md`.
