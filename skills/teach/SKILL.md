...
Filenames are: `M01-welcome-foundations.md`, `M02-prompt-engineering.md`, `M03-cowork-ui-settings.md`, `M04-artifacts.md`, `M05-skills-slash-commands.md`, `M06-chief-of-staff-claudemd.md`, `M07-obsidian.md`, `M08-projects-folders-claudemd.md`, `M09-connectors.md`, `M10-browser-chrome.md`, `M11-office-add-ins.md`, `M12-scheduled-tasks-routines.md`, `M13-gtd-in-your-vault.md`, `M14-daily-command-center.md`, `M15-meeting-notes.md`, `M16-collaboration.md`.
